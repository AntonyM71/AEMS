...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        op.f("sth_uq_availableBonuses_id"), "availableBonuses", ["id"]
    )
    op.create_unique_constraint(
        op.f("sth_uq_availableMoves_id"), "availableMoves", ["id"]
    )
    ...
    op.create_unique_constraint(
        op.f("sth_uq_scoredBonuses_id"), "scoredBonuses", ["id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        op.f("sth_uq_availableMoves_id"), "availableMoves", type_="unique"
    )
    op.drop_constraint(
        op.f("sth_uq_availableBonuses_id"), "availableBonuses", type_="unique"
    )
